...
// import { productlist } from "../../data/officeequipments";
import styled from "styled-components";
import { HomeGoodsSlides } from "../../components/HomeGoods/HomeGoodsList";
        ...
        <SingleProductWrapper>
          <article className="product-section sections">
            <div className="product">
              ...
              <div className="share-product">
                ...
                <div className="socials">
                  <img
                    src={require("../../assets/img/singleproduct/29.png")}
                    alt="share product"
                  />
                  <img
                    src={require("../../assets/img/singleproduct/30.png")}
                    alt="share product"
                  />
                  <img
                    src={require("../../assets/img/singleproduct/31.png")}
                    alt="share product"
                  />
                </div>
              </div>
            ...
            <div className="product-description">
              <div className="description">
                {/* <h5>{singleproduct.type}</h5> */}
                <p className="rating">
                  <img
                    src={require("../../assets/img/singleproduct/34.png")}
                    alt="rating"
                  />
                  <img
                    src={require("../../assets/img/singleproduct/34.png")}
                  ...
                  />
                  <img
                    src={require("../../assets/img/singleproduct/35.png")}
                    alt="rating"
                  />
                  <span>(8 rating)</span>
                </p>
          ...
          <article className="sections section-2">
            ...
            <div className="text">
              <span>10 Sold</span>
              <p>
                If you are looking for comfort and durable product with perfect
                or excellent finish, 'Pawa furniture' is the solution. We make
                quality home and office furniture with high class material and
                at best price.
              </p>
              <p>
              ...
              <p>
                For durability: we treat the woods we use. we frame the skeleton
                with board for extra protection, we use high density foam and
                high- quality fabric.
              </p>

              <p>
                Shop here and enjoy all these benefits and above all we keep our
                word
              </p>
